...
public class AppTest {
	  public static OkHttpClient client;
	   ...
	   public String BASE_URL = "https://mockk-server.herokuapp.com";
 ...
 @Test
    public void simple_get_request() throws IOException {
        ...
        assertTrue(response.code() == 200 ,"Response code should be 200");
    }
...
//        assertTrue(passed_param.equals(some_param), "param should be 'some_param'");
//        assertTrue(response.code() == 200, "Response code should be 200");
//    }
//
//    @Test(priority=3)
...
//        
//        assertTrue(sent_body.equals("This is my body") ,"body should match");
//
//        // Like wise we can assert other things as well. 
//        assertTrue(response.code() == 200 ,"response should be 200");
//    }
}
